 ...
 *
 * Back-compat: an older revision read telegram_bot_token / telegram_chat_id
 * from /run/secrets and $OPENCLAW_STATE_DIR/secrets; those paths no longer
 * exist after the secrets-consolidation refactor.
 */

 ...
 * and proxies requests to the wizard (setup-server) when it's active. When no
 * wizard is running, serves a static HTML page directing users to Telegram.
 *
...
<body>
<h1>Limbo</h1>
<p>Your instance is running. Use Telegram to chat.</p>
</body>
</html>`;
